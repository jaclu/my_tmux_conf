...
class PluginDisplay:
    ...
    def display_info(self) -> None:
        ...
        skipped_plugins = self._registry.get_skipped_plugins()

        self._print_header()
        max_l_name = self._calculate_max_name_length(used_plugins)
        plugin_items = self._get_installed_plugin_items()
    ...
    def _calculate_max_name_length(self, used_plugins: dict) -> int:
    ...
    def _display_used_plugins(
        self, used_plugins: dict, plugin_items: list[str], max_l_name: int
    ) -> None:
    ...
    def _display_plugin_verbose(
        self, name: str, info: dict, plugin_items: list[str], max_l_name: int
    ) -> None:
